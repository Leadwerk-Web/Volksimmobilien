...
$scout_url       = 'https://www.immobilienscout24.de/anbieter/profil/volksimmobilien-km-gmbh';
?>
	...
	<div class="container footer-grid">
		<div class="footer-col footer-col--brand">
			...
			<div class="footer-cta-row">
				...
				<a href="<?php echo esc_url( $scout_url ); ?>" class="btn btn-outline-light btn-sm" target="_blank" rel="noopener">Angebote</a>
			</div>
		</div>
