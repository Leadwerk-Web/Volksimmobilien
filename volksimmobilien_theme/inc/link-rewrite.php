...
function volks_known_section_css_backgrounds() {
	return array(
		...
		'cta-section--rheinstetten-bg'       => 'Fotos/Rheinstetten/rheinstetten-moersch-kirche.jpg',
		'cta-section--au-am-rhein-bg'        => 'Fotos/Au-am-Rhein/au-am-rhein-kirche.jpg',
		'cta-section--rastatt-bg'            => 'Fotos/Rastatt/rastatt-schloss.jpg',
		'cta-section--ettlingen-bg'          => 'Fotos/Ettlingen/ettlingen-schloss.jpg',
		'cta-section--gaggenau-bg'           => 'Fotos/Gaggenau/gaggenau-panorama.jpg',
		'cta-section--malsch-bg'             => 'Fotos/Malsch/malsch-ort.jpg',
		'cta-section--gewerbeimmobilien-bg'  => 'Fotos/Gewerbe/gw-gewerbepark.jpg',
		'cta-section--mehrfamilienhaus-bg'   => 'Fotos/MFH/mfh-durlach.jpg',
	);
}
...
function volks_apply_section_css_background_variables( $html, $background_rows = array(), $css_section_background = 0, $css_section_background_class = '' ) {
	...
	$known = volks_known_section_css_backgrounds();
	$pattern = '/(' . implode( '|', array_map( 'preg_quote', array_keys( $known ) ) ) . ')/';
